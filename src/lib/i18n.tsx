...
const EN_MESSAGES: Record<string, string> = {
  ...
  裁剪图标: 'Crop icon',
  '拖动图标调整位置，使用滚轮或滑杆缩放。':
    'Drag the icon to reposition it, then use the wheel or slider to zoom.',
  '拖动图标调整位置，使用滚轮或缩放按钮缩放。':
  ...
  向右旋转: 'Rotate right',
  复位: 'Reset',
  清晰优化: 'Enhance clarity',
  已优化: 'Enhanced',
  取消清晰优化: 'Disable clarity enhancement',
  '正在优化...': 'Enhancing...',
  '无法优化图片，请重试。': 'Unable to enhance the image. Please try again.',
  图标背景: 'Icon background',
  提取颜色: 'Pick color',
  点击图片提取颜色: 'Click the image to pick a color',
  选择提取的颜色: 'Choose sampled color',
  透明背景: 'Transparent background',
  选择图标背景: 'Choose icon background',
  '此处没有可提取的颜色，请选择图片中的其他位置。':
    'There is no color to sample here. Choose another point in the image.',
  '无法提取颜色，请重试。': 'Unable to pick a color. Please try again.',
  '正在生成...': 'Generating...',
  完成: 'Done',
  应用裁剪: 'Apply crop',
  '无法生成裁剪后的图标，请重试。': 'Unable to generate the cropped icon. Please try again.',
  图标类型: 'Icon type',
  展开选项: 'Expand options',
  ...
  石墨: 'Graphite',
  图标文字: 'Icon text',
  输入最多六个字符: 'Enter up to six characters',
  '最多使用六个字符生成图标，内容较长时会自动缩小并保持单行。':
    'Use up to six characters. Longer text shrinks automatically to stay on one line.',
  '未能从自定义文件提取图标，请重新选择。':
