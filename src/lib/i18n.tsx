...
const EN_MESSAGES: Record<string, string> = {
  ...
  '关于': 'About',
  '显示 Dock 栏': 'Show Dock',
  '当前已开启，Dock 会在启动台底部显示。': 'Dock is on and will appear at the bottom of the launchpad.',
  ...
  '已选择文件夹，请点击“保存路径”后生效。':
    'Folder selected. Click "Save path" to apply it.',
  ...
  '已恢复使用默认自定义应用目录。':
    'Reverted to the default custom app directory.',
  ...
  '图标布局已重置，主窗口已刷新。':
    'Icon layout reset. The main window has been refreshed.',
  '图标布局已重置，主窗口下次同步时会应用。':
  ...
  '当前已经是默认快捷键：{shortcut}。':
    'The current shortcut is already the default: {shortcut}.',
  ...
  '为保证加载速度，预览内容已截断。':
    'Preview content has been truncated to keep loading fast.',
  ...
  '允许按 Enter 打开当前选中的结果。':
    'Allow Enter to open the currently selected result.',
  '双击打开结果': 'Double-click to open',
  '允许通过鼠标双击打开结果项。':
    'Allow mouse double-click to open a result item.',
  '防抖时间': 'Debounce',
  ...
  '让关键字匹配包含完整路径片段。':
    'Allow keywords to match parts of the full path.',
  ...
  '正在等待安装程序返回下载信息...':
    'Waiting for the installer to report download information...',
  '已下载 {downloaded} / {total} ({percent}%)':
