...
export const isLaunchpadOpenFocusTarget = (value: unknown): value is LaunchpadOpenFocusTarget =>
  value === 'search' || value === 'launchpad'

export const normalizeLaunchpadOpenFocusTarget = (value: unknown): LaunchpadOpenFocusTarget =>
