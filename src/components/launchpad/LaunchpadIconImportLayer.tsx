          ...
          >
            {isExternalDragActive ? (
              <div className="p-5 sm:p-6">
                <div className="flex min-h-64 flex-col items-center justify-center rounded-xl border-2 border-dashed border-primary/45 bg-primary/[0.04] px-6 py-10 text-center">
