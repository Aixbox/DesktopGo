...
import type {
  FootprintEvasionResult,
  PagePlacementEntry,
  PlacementCandidateFilterContext,
} from './footprintPlacementPolicy'
import {
  attemptSingleStepDirectionalFootprintEvasion,
  buildDirectionalOverlapCandidatePredicate,
  collectPagePlacementEntries,
  CURRENT_PAGE_FOOTPRINT_STRATEGIES,
  pickBetterCurrentPageFootprintResult,
...
const attemptFootprintEvasion = ({
  ...
  const currentPageEntries = collectPagePlacementEntries({
    ...
    itemById,
    rangeStart: pageStart,
    rangeEndExclusive: currentPageRangeEnd,
    pageStart,
    pageSize,
    columns,
    reservedSet,
  ...
  const allEntries = collectPagePlacementEntries({
    ...
    itemById,
    rangeStart: pageStart,
    rangeEndExclusive: order.length,
    pageStart,
    pageSize,
    columns,
    reservedSet,
