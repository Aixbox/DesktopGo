...
import { Bot, FolderClosed, Loader2, X } from 'lucide-react'
...
export function AiOrganizePanel({
  ...
  const runClassification = useCallback(async () => {
    ...
    try {
      ...
      const result = await invoke<AiClassifyResult>('ai_classify_icons', {
  ...
  return (
    ...
    >
      <div className="flex max-h-[80vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-border bg-background shadow-2xl">
