    ...
    return (
      ...
      >
        <motion.aside
          ...
          className={`flex h-full w-full flex-col overflow-hidden rounded-2xl border border-border/85 bg-card/95 backdrop-blur-xl ${isExpanded ? 'shadow-2xl' : 'shadow-none'}`}
