    ...
    <div className="px-3 py-3">
      ...
      <div className="space-y-2">
        {entries.map(entry => (
          <div
            key={entry.id}
            className="search-surface-card flex items-center gap-2 rounded-lg px-3 py-2 transition-colors hover:bg-accent/45"
          >
            <button
              type="button"
            ...
            >
              <div className="truncate text-sm text-foreground">{entry.keyword}</div>
